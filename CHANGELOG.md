...
- **README** rewritten with GitHub alerts, collapsible sections, a key-binding table, credits and a privacy section. `doc/header.svg` recoloured Solarized Dark with the shimmer seekbar. All screenshots retaken on this build in SDR (a GDI grab of an HDR window blows out OSD colours), plus new which-key and stats shots; Configuration Manager screenshot updated.
